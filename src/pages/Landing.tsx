...
const Landing = () => {
	...
	const [state, setStates] = React.useState({
		showMenu: false,
		contractAddress: '0xXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX',
		showCollapse1: true,
		showCollapse2: false,
		showCollapse3: false,
		showCollapse4: false,
						...
						<div className="section-1">
								...
								<div className="col-lg-6 col-md-12 row center middle">
									<div>
										...
										<ScrollAnimation animateIn="slideInUp" animateOut="fadeOutUp">
											<p>The future of Dual Reward with Auto-Staking, Auto-Compounding & Reflection Rewards all together!</p>
											<p>Rebasing paid at every 10 minutes and dividends paid on every buy and sell.</p>
											<p>A simple buy-hold-earn system that grows your holded token and reflection rewards in your wallet at a lightning-fast pace.</p>
										</ScrollAnimation>
							...
							<div className="row center mt5 pt5">
								<ScrollAnimation animateIn="slideInUp" animateOut="fadeOut" >
									<h3 className='text-blue p3 text-center' style={{fontWeight:'bold'}}>Presale starts in</h3>
								</ScrollAnimation>
							</div>
								<div className="row center mt3">
									<div>
										...
										<ScrollAnimation animateIn="flipInX" animateOut="fadeOut" >
											<div className="timecard">{state.days === 0 ? '-' : parseInt((state.days / 10).toString() )}</div>
										</ScrollAnimation>
										<ScrollAnimation animateIn="flipInX" animateOut="fadeOut" delay={250}>
											<div className="timecard">{state.days === 0 ? '-' : (state.days % 10)}</div>
										</ScrollAnimation>
									</div>
								</div>
								<div>
								...
								<div>
									...
									<div className="timebar">
										<ScrollAnimation animateIn="flipInX" animateOut="fadeOut" delay={140}>
											<div className="timecard">{state.hours === 0 ? '-' : (parseInt((state.hours / 10).toString() ))}</div>
										</ScrollAnimation>
										<ScrollAnimation animateIn="flipInX" animateOut="fadeOut" >
											<div className="timecard">{state.hours === 0 ? '-' :  (state.hours % 10)}</div>
										</ScrollAnimation>
									</div>
								</div>
								<div>
								...
								<div>
									...
									<div className="timebar">
										<ScrollAnimation animateIn="flipInX" animateOut="fadeOut" delay={140}>
											<div className="timecard">{state.minutes === 0 ? '-' : (parseInt((state.minutes / 10).toString() ))}</div>
										</ScrollAnimation>
										<ScrollAnimation animateIn="flipInX" animateOut="fadeOut" >
											<div className="timecard">{state.minutes === 0 ? '-' :  (state.minutes % 10)}</div>
										</ScrollAnimation>
									</div>
								</div>
								<div>
									...
									<div className="timebar">
										<ScrollAnimation animateIn="flipInX" animateOut="fadeOut" delay={100}>
											<div className="timecard">{state.seconds === 0 ? '-' : (parseInt((state.seconds / 10).toString() ))}</div>
										</ScrollAnimation>
										<ScrollAnimation animateIn="flipInX" animateOut="fadeOut" delay={200}>
											<div className="timecard">{state.minutes === 0 ? '-' : (state.seconds % 10)}</div>
										</ScrollAnimation>
									</div>
								</div>
								<div>
						...
						<div className="mt5 mb5">
							<div className="row center middle p3">
								<div className="col-lg-6 col-md-12">
									...
									<ScrollAnimation animateIn="slideInUp" animateOut="fadeOut" >
										<p>We believe that investors should be rewarded for holding their tokens instead of simply waiting, and hoping, for the price to pump.</p>
										<p>We have implemented two types of rewards for our holders. </p>
										<p>3047.52 tokens are distributed to all holders every 10 minutes and 3% of buy and sell tax is distributed to all holders.</p>
										<p>Additionally, 20% of the sell amount will be burned from outstanding token to deflate supply and increase the value of the token.</p>
										<p>4% of the tax goes to liquidity, and the remaining 3% goes to growth funds. So this makes up a total of 10% tax when buy and sell.</p>
										<p>Holders can transfer tokens without fee.</p>
									</ScrollAnimation>
								</div>
								<div className="col-lg-6 col-md-12 row center middle">	
									<div className="background">
						...
						<div className="row center middle p3">
							...
							<div className="col-lg-6 col-md-12 p3">
								<ScrollAnimation animateIn="slideInUp" animateOut="fadeOut">
									...
									<p>Our vision for the ecosystem is to deliver multiple projects that provides actual use-case utility.</p>
									<p>Evoki Protocol is a variable, continuous compounding, interest rebase token with a fully automated dividend distribution mechanism.</p>							
									<p>Evoki Protocol provide rebase rewards for 5 years.</p>
									<p>3047.52 tokens are distributed to all holders every 10 minutes and 3% of buy and sell tax is distributed to all holders.</p>
									<p>To ensure a stability of price, every sell transaction will burn 20% of the sell token amount from total supply directly to the Black Hole (dEAd address).</p>
									<p>This ensures the Evoki tokens in the liquidity pool does not exponentially rebase with an overload amount which would cause the price to crash over time.</p>
								</ScrollAnimation>
							</div>
						</div>
					</div>
						...
						<ScrollAnimation animateIn="flipInX" animateOut="fadeOut">
							...
							<div className="row center ml-auto mr-auto">
								<p className='text-center p3' >
									Evoki is the token which interest rebase rewards are paid. 
									Every token holder automatically receives 282% interest and reflection rewards for a year, just for holding $Evoki tokens in their own wallet! 
								...
								<ScrollAnimation animateIn="fadeIn" animateOut="fadeOut">
									<div className="card">
										...
										<div>
											...
											<p className='m0 mt1'>
												Crypto’s Highest Paying Auto-Staking and Auto-Compounding Protocol with the greatest fixed APY in the industry of 282%. 
												Interest rewards are compounded every 10 minutes automatically to every BSC wallet that is holding any Evoki tokens.
											</p>
										</div>
									</div>
								</ScrollAnimation>
								<ScrollAnimation animateIn="fadeIn" animateOut="fadeOut">
									<div className="card">
										...
										<div>
											...
											<p className='m0 mt1'>
												The EPDF serves as a Evoki dividends to achieve profitability, stability and long term sustainability of the Evoki Protocol, and not by just maintaining a consistent 282% rebase rate, but by paying Evoki dividends to all token holders.
												Evoki Protocol Growth Funds Vault.
											</p>
										</div>
									</div>
								</ScrollAnimation>
								...
								<ScrollAnimation animateIn="fadeIn" animateOut="fadeOut">
									<div className="card">
										...
										<div>
											...
											<p className='m0 mt1'>
												The Growth Funds provides support to the EPDF in the event of an extreme price drop for the Evoki token.
												The Growth Funds will also be utilized for Buy Back to support the value of Evoki token and used to develop Ecosystem projects.
											</p>
										</div>
									</div>
								</ScrollAnimation>
								...
								<ScrollAnimation animateIn="fadeIn" animateOut="fadeOut">
									<div className="card" >
										...
										<div>
											...
											<p className='m0 mt1'>
												20% of sold amount are burned using the Black Hole (dEAd address). 
												The more that is sold, the more that is put into the black hole. 
												Causing the blackhole to inflate and magnify in size thus reducing the circulating supply and keeping the Luzion Protocol value stable.
											</p>
										</div>
									</div>
								</ScrollAnimation>
								<ScrollAnimation animateIn="fadeIn" animateOut="fadeOut">
									<div className="card">
										...
										<div>
											...
											<p className='m0 mt1'>
												Liquidity allows for anybody to buy & sell their Evoki/BNB at anytime, however the less money/liquidity there is in the pool, the worse price you get.
											</p>
										</div>
									</div>
								</ScrollAnimation>
							...
							<div className="col-lg-4 cold-md-12" style={{paddingTop:'5em'}}>
								<ScrollAnimation animateIn="flipInY" animateOut="fadeOut">
									<div className="card p3">
										...
										<h3>Evoki Token</h3>
										<p>The Evoki Protocol is the heartbeat of our entire ecosystem, providing more than just a DeFi protocol token.</p>
									</div>
								</ScrollAnimation>
							</div>
							<div className="col-lg-4 cold-md-12" style={{paddingTop:'5em'}}>
							...
							<div className="col-lg-4 cold-md-12" style={{paddingTop:'5em'}}>
								<ScrollAnimation animateIn="flipInY" animateOut="fadeOut" delay={700}>
									<div className="card p3">
										<img src={logo} alt="logo" />
										<h3>EVK Verse</h3>
										<h4 className='p0'>Coming 2024</h4>
									</div>
								</ScrollAnimation>
							</div>
						</div>
					...
					<div className="container">
						...
						<ScrollAnimation animateIn="fadeIn" animateOut="fadeOut">
							<div className="collapse p3">
								...
								{
									state.showCollapse1 && <div className="content">We can buy Evoki token from our dapp or pancakeswap.</div>
								}
							</div>
							<div className="collapse p3">
								...
								{
									state.showCollapse2 && <div className="content">Our token don’t have transfer fee.</div>
								}
							</div>
							<div className="collapse p3">
								...
								{
									state.showCollapse3 && <div className="content">Our entire protocol's smart contract was written and developed from scratch from our own competent group of developers. It does not contain any resemblance to Titano's code or operation as Evoki works on a completely new set of mechanics which allows for complete protocol sustainability.</div>
								}
							</div>
							<div className="collapse p3">
								...
								{
									state.showCollapse4 && <div className="content">
										Creating price stability, achieving sustainability, reducing drawdown risks.
										https://bscscan.com/address/0xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
									</div>
								}
							</div>
							...
							<div className="collapse p3">
								<div className="justify pointer" onClick={() => {updateStatus({showCollapse5: !state.showCollapse5})}}>
									<div className="title">What is the Evoki auto-liquidity engin(EALE) wallet address?</div>
									<div className="close">
										<img src={arrow} alt="arrow" style={{transform:`${state.showCollapse5? '': 'rotateX(180deg)'}`}}/>
									</div>
								</div>
								{
									state.showCollapse5 && <div className="content">
										Every 24 hours at 0:0:0 UTC time our (EALE) will inject automatic liquidity into the market.
										https://bscscan.com/address/0xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
									</div>
								}
							</div>
					...
					<div className="row p3">
						...
						<div className="col-lg-3 col-md-6 col-sm-12 p3">
							<ScrollAnimation animateIn="fadeIn" animateOut="fadeOut" delay={600}>
								<h4>Evoki Ecosystem</h4>
								<Link to="/" className='footer-menu'>Evoki Protocol</Link>
								<Link to="/" className='footer-menu'>EVK Blockchain (COMING 2023)</Link>
								<Link to="/" className='footer-menu'>Evoki Verse (COMING 2024) </Link>
							</ScrollAnimation>
						</div>
						<div className="col-lg-3 col-md-6 col-sm-12 p3">
							<ScrollAnimation animateIn="fadeIn" animateOut="fadeOut" delay={800}>
								<h4>Evoki Community</h4>
